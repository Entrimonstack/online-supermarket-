...
import emptyCartImage from "../../img/s.png.jpg"
...
//       // Ensure you're getting the session ID from the response correctly
//       const sessionId = data.id; // Assuming data has a structure like { id: "session_id" }
...
const handlePayment = async () => {
  if (user.email) {
      ...
      // Ensure you're getting the session ID from the response correctly
      const sessionId = data.sessionId; // Adjusted to match the object structure you logged
